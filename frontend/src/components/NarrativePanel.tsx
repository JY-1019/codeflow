...
export function NarrativePanel({ graph, assistantResponse }: NarrativePanelProps) {
  ...
  return (
    <div className="flex h-full flex-col bg-slate-900/70">
      <div className="flex items-center gap-2 border-b border-slate-800 px-3 py-2 text-[12px] font-semibold uppercase tracking-wider text-slate-400">
